...
# 🔥 News
- *2025.10*: We release 🛠️ [DeepAgent](https://arxiv.org/abs/2510.21618), a general reasoning agent with scalable toolsets, featured as [HF Daily Paper #1](https://huggingface.co/papers/date/2025-10-27). Check out our [demo](https://github.com/RUC-NLPIR/DeepAgent)!
- *2025.10*: We release [AEPO](https://arxiv.org/abs/2510.14545), an entropy-balanced agentic RL method, featured as [HF Daily Paper #2](https://huggingface.co/papers/2510.14545)!
- *2025.09*: 🌐 [WebThinker](https://arxiv.org/abs/2504.21776) accepted by **NeurIPS 2025** and reaching **1200 stars** and **100 citations**! It's a powerful open-source deep research agent. Check out our [demo](https://github.com/RUC-NLPIR/WebThinker)!
...
- *2025.02*: Our survey on Generative Information Retrieval accepted by **TOIS**! See more [details](https://arxiv.org/abs/2404.14851).
